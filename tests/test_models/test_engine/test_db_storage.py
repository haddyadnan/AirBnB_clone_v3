...
class TestFileStorage(unittest.TestCase):
    ...
    def test_get_method(self):
        ...
        instance1 = State(**{"name": "Lao"})
        models.storage.new(instance1)
        models.storage.save()
        instance2 = models.storage.get(State, instance1.id)
    ...
    def test_count_method(self):
        ...
        all_storage = len(models.storage.all())
        self.assertEqual(count, all_storage)
